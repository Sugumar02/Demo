...
echo " "
echo "CLEAR  QL(Jenkins.Input.Queue1)" >> tmp_mqs_script.mqsc
echo "DELETE QL(Jenkins.Input.Queue1)" >> tmp_mqs_script.mqsc
echo "CLEAR  QL(Jenkins.Output.Queue1)" >> tmp_mqs_script.mqsc
echo "DELETE QL(Jenkins.Output.Queue1)" >> tmp_mqs_script.mqsc
