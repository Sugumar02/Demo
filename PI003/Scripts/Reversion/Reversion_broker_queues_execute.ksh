...
echo "DELETE QA(ESB.TEST)" >> tmp_mqs_script.mqsc
echo " " >> tmp_mqs_script.mqsc
echo "CLEAR  QL(ESB.TEST1.BAK)" >> tmp_mqs_script.mqsc
echo "DELETE QL(ESB.TEST1.BAK)" >> tmp_mqs_script.mqsc
echo " " >> tmp_mqs_script.mqsc
echo "CLEAR  QL(ESB.TEST1)" >> tmp_mqs_script.mqsc
echo "DELETE QL(ESB.TEST1)" >> tmp_mqs_script.mqsc
echo " " >> tmp_mqs_script.mqsc
